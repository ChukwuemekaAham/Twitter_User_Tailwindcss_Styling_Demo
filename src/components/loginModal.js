...
const Loginmodal = () => {
  ...
  <Popup
      trigger={<button class=" mt-2 py-2 text-white bg-blue-500 w-full rounded-full">Sign up</button>}
      modal
      nested
    ...
    {close => (
        ...
        <div class="modal bg-gradient-to-tr from-blue-900 to-blue-500 p-5 rounded">
          ...
          {' '}
          <div class="bg-image w-full shadow-md flex flex-col md:flex-row items-center rounded z-10 overflow-hidden bg-center bg-cover bg-blue-600">
          ...
          <div class="flex text-center pt-2">
            <button
              class="flex  bg-blue-200 hover:bg-blue-300 text-blue focus:outline-none focus:ring rounded px-2 py-1"
              onClick={() => {
                close();
              }}
            >
